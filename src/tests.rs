...
mod test_module {
    ...
    use cosmwasm_std::{
        attr, coin, Addr, Attribute, BankMsg, Coin, CosmosMsg, Decimal256, MessageInfo, Response,
        SubMsg, Timestamp, Uint128, Uint256, Uint64,
    };
    ...
    fn test_create_stream() {
        ...
        assert_eq!(res.unwrap_err().to_string(), "NoFundsSent");

        // wrong supply amount case
        let mut env = mock_env();
        env.block.time = Timestamp::from_seconds(1);
        let info = mock_info("creator1", &[Coin::new(1_000_000u128, "out_denom")]);
        let res = execute_create_stream(
            deps.as_mut(),
            env,
            info,
        ...
        // let info = mock_info(
        //     "creator1",
        //     &[Coin::new(out_supply, "out_denom"), Coin::new(99u128, "fee")],
        // );
        // let res = execute_create_stream(
        //     deps.as_mut(),
        //     env,
        ...
        //     "v1".to_string(),
        // );
        // assert_eq!(res.unwrap_err().to_string(), "StreamCreationFeeRequired");

        // // no creation fee case
        // let mut env = mock_env();
        // env.block.time = Timestamp::from_seconds(1);
        // let info = mock_info("creator1", &[Coin::new(out_supply, "out_denom")]);
        // let res = execute_create_stream(
        //     deps.as_mut(),
        //     env,
        //     info,
        ...
        // let mut env = mock_env();
        // env.block.time = Timestamp::from_seconds(1);
        // let info = mock_info("creator1", &[Coin::new(1u128, "fee")]);
        // let res = execute_create_stream(
        //     deps.as_mut(),
        //     env,
        //     info,
        ...
        //     "v1".to_string(),
        // );
        // assert_eq!(res.unwrap_err().to_string(), "StreamOutSupplyFundsRequired");
        ...
        //     "creator1",
        //     &[Coin::new(
        //         out_supply.strict_add(Uint256::from(100u128)),
        //         "fee",
        //     )],
        // );
        ...
        //     "creator1",
        //     &[
        //         Coin::new(out_supply.strict_add(Uint256::from(100u128)), "fee"),
        //         Coin::new(15u128, "random"),
        //     ],
        // );
        // let mut env = mock_env();
        // env.block.time = Timestamp::from_seconds(1);
        ...
        // )
        // .unwrap_err();
        // assert_eq!(err.to_string(), "InvalidFunds");

        // // different tokens extra funds sent
        // let info = mock_info(
        //     "creator1",
        //     &[
        //         Coin::new(out_supply, "different_denom"),
        ...
        // )
        // .unwrap_err();
        // assert_eq!(res.to_string(), "StreamNameTooShort");
        ...
        // )
        // .unwrap_err();
        // assert_eq!(res.to_string(), "StreamNameTooLong");
        ...
        // )
        // .unwrap_err();
        // assert_eq!(res.to_string(), "InvalidStreamName");
        ...
        // )
        // .unwrap_err();
        // assert_eq!(res.to_string(), "StreamUrlTooShort");
        ...
        // )
        //     .unwrap_err();
        // assert_eq!(res.to_string(), "StreamUrlTooLong");
        ...
        // assert_eq!(res.to_string(), "InvalidStreamUrl");
        ...
        // )
        // .unwrap_err();
        // assert_eq!(res.to_string(), "InvalidToSVersion");
...
//         use cosmwasm_std::{Binary, ReplyOn, SubMsg};
...
//                                 denom: "out_denom".to_string(),
//                                 amount: Uint256::from(1000000000000)
//                             }])
//                         }),
//                         gas_limit: None,
